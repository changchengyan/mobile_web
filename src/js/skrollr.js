! function (e, t, r) {
    ...
    function n(r) {
        if (o = t.documentElement, a = t.body, Y(), le = this, r = r || {}, me = r.constants || {}, r.easing)
            for (var n in r.easing) X[n] = r.easing[n];
        Te = r.edgeStrategy || "set", fe = {
            beforerender: r.beforerender,
            render: r.render,
            keyframe: r.keyframe
        }, ue = r.forceHeight !== !1, ue && (ze = r.scale || 1), pe = r.mobileDeceleration || x, ge = r.smoothScrolling !== !1, ve = r.smoothScrollingDuration || A, he = {
            targetTop: le.getScrollTop()
        }, Ke = (r.mobileCheck || function () {
    ...
    var j = function () {
        ...
        W = function () {
            ...
            for (c = 0, f = se.length; f > c; c++)
                for (e = se[c], t = e.element, r = e.anchorTarget, n = e.keyFrames, a = 0, i = n.length; i > a; a++) l = n[a], u = l.offset, m = d[l.constant] || 0, l.frame = u, l.isPercentage && (u *= p, l.frame = u), "relative" === l.mode && (ae(t), l.frame = le.relativeToAbsolute(r, l.anchors[0], l.anchors[1]) - u, ae(t, !0)), l.frame += m, ue && !l.isEnd && l.frame > Ve && (Ve = l.frame);
        ...
        J = function () {
            ...
            if (Ke && ce && i.setStyle(ce, "transform", "translate(0, " + -Ye + "px) " + be), ye || Le !== n) {
                ...
                s !== !1 && (Z(n, le.getScrollTop()), Le = n, fe.render && fe.render.call(le, l)), e && e.call(le, !1)
            }
            Me = o
        },
        Q = function (e) {
